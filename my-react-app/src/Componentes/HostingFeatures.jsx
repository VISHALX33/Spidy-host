...
function HostingFeatures() {
  return (
    <div className='p-10' >
      <h1 className='text-5xl m-auto py-16'>
        Unlimited cPanel Cloud Hosting Features
      </h1>
      <p className='text-gray-600 m-auto text-xl mb-9'>Experience smooth and hassle-free hosting with our unlimited cPanel Cloud <br /> Hosting, equipped with top-notch features.</p>
